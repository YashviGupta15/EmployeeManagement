...
export class AddEmployeeComponent implements OnInit {
  ...
  validate() {
    ...
    if (
      this.EmployeeData.name == undefined ||
      ...
      this.EmployeeData.location == undefined ||
      this.EmployeeData.location == '' ||
      this.EmployeeData.location == null
    ) {
      this.errorMessage = 'Please provide valid location';
      this.isValidForm = false;
    } else if (
      this.EmployeeData.mobile == undefined ||
      this.EmployeeData.mobile.toString() == '' ||
      this.EmployeeData.mobile == null
    ) {
